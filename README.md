...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=22&pause=1000&color=A78BFA&center=true&vCenter=true&width=500&lines=Full+Stack+Developer;React+%2B+NestJS+%2B+PostgreSQL;Software+Engineering+%40+FIAP;Sempre+aprendendo+algo+novo+%F0%9F%9A%80" alt="Typing SVG" />

</div>

```json
{
  "name": "Gustavo Firmino",
...
|---|---|---|
| **ITESP** | Sistema web para projeto governamental (DMK3) | React · TanStack · NestJS · Prisma · TypeORM · PostgreSQL |
| **Cadastro de Usuários** | Sistema de cadastro e autenticação de usuários | React · NestJS · Prisma · Supabase |
